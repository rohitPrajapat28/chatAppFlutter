...
class PreferenceManager {
 ...
 //  }
  ...
  static Future<List<T>> getDataList<T>(String keyName, T Function(Map<String, dynamic>) fromJson) async {
    final prefs = await SharedPreferences.getInstance();
    ...
    if (data != null) {
      try {
        ...
        return decodedList.map<T>((item) => fromJson(item as Map<String, dynamic>)).toList();
      } catch (e) {
